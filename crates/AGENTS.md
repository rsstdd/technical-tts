...
- Load `.claude/skills/rust-review/SKILL.md`, `.claude/skills/clean-code/SKILL.md`, `.claude/skills/ponytail/SKILL.md`, and `.claude/skills/rust-comment/SKILL.md` before writing, generating, auditing, or editing anything in this tree. They are binding standards here, not advice to weigh. The review standard governs generation, not only review: writing to it costs less than being refactored to it. Before reporting done, run its review sections and severity scale against your own diff.
