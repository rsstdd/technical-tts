...
| `cargo test --workspace --offline --locked --all-targets` | Pass, 306 tests; 10 consecutive runs clean |
...
| `python3 scripts/check-evidence-provenance.py` | Pass, exits zero; the eleven moved pins are accounted for by the accepted `e1-s2-evidence-provenance-reconciliation-v3`, which supersedes v2 |
