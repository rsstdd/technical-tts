...
| `python3 scripts/check-evidence-provenance.py` | Pass, 0 unaccounted mismatches. It exited zero when first run and exited 1 at the sixth review, on the three v13 pins the twenty-second E1-S1 audit moved; `e1-s1-provisional-contract-baseline-v14` was accepted on 2026-08-30 and supersedes v13, so v13 is no longer checked and the branch is green. The eleven pins E1-S2 moved were accounted for by the accepted `e1-s2-evidence-provenance-reconciliation-v3` and are retired with v13 |
