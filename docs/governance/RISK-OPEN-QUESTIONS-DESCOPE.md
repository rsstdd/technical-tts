...
|---|---|---:|---:|---|---|
| R-01 | CPU-only Chatterbox misses RTF gate | Medium | High | G0 real render, measured reforecast, reopen hardware/backend decision | RTF > 6.0; engineering owner |
| R-02 | Model or voice rights block intended use | Medium | Critical | Rights records and owner-recorded fallback | Missing or incompatible permission; project owner |
| R-03 | Chatterbox output WAV is unsupported or inconsistent | Low | High | Variant round-trip test and bounded decoder fallback | G0 compatibility failure; engineering owner |
| R-04 | Model output is not byte deterministic | High | Medium | First-valid-artifact-wins cache and retained artifact reconstruction | Determinism evidence; engineering owner |
| R-05 | WSL2 resource topology causes oversubscription | Medium | High | Physical-core detection, conservative fallback, RAM/core validation | Resource-gate failure; runtime owner |
| R-06 | Native ASR integration delays G3 | Medium | Medium | Keep ASR outside M2 and preserve human-review authority | E4-S0 estimate breach; project owner |
| R-07 | ASR gates fail | Medium | High | Improve verifier or amend release control to full human review | Any ADR-0005 class failure; project owner |
| R-08 | Content or voice data leaks through logs/artifacts | Low | Critical | Redaction defaults, governed roots, CI fixture policy | Any leak; security owner |
| R-09 | Filesystem corruption or interrupted writes lose work | Low | High | Atomic publication, checksums, reconciliation, fault injection | Integrity failure; runtime owner |
| R-10 | Solo-engineer review blind spot | Medium | Medium | Independent listener, explicit role sign-offs, contract suites | G1 and M3; project owner |
| R-11 | Upstream model/tool drift invalidates evidence | Medium | High | Pin identities, qualification checksums, upgrade impact report | Any dependency change; engineering owner |
| R-12 | Backlog process consumes delivery capacity | Medium | Medium | One source of truth, generated views, minimum required records | Weekly review; project owner |
