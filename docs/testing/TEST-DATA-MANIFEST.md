...
| lesson-two-segment-v1 | Lesson JSON | Walking skeleton | `fixtures/lessons/e0-s0-two-segment.json` | SHA-256 `13982d762f251df912991b68add47dc43fa47e6a9be1df4538bee125009189b0` | Owner-authored for this repository | No | Repository lifetime | Project owner | Active |
