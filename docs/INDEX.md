...
| E1-S2 canonical lesson fields, closed vocabularies, planned transcript | [`architecture/E1-S2-INTERFACE-CHANGE-002.md`](architecture/E1-S2-INTERFACE-CHANGE-002.md), `Proposed` and unsigned; carries the lesson document to `3.1` and the render plan to `2.0`, and records twelve corrections across five rounds |
...
| E1-S2 story evidence, `Proposed` until G1 | [`../evidence/gates/g1/e1-s2/e1-s2-canonical-lesson-workflow-v1.md`](../evidence/gates/g1/e1-s2/e1-s2-canonical-lesson-workflow-v1.md). Provenance reconciliation sits beside it in [`…-reconciliation-v3.md`](../evidence/gates/g1/e1-s2/e1-s2-evidence-provenance-reconciliation-v3.md), which supersedes v2 and through it v1, and accounts for the eleven `e1-s1-provisional-contract-baseline-v13` pins E1-S2 moved, read against every round of `E1-S2-INTERFACE-CHANGE-002` |
