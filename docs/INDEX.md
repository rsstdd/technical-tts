...
| E1-S1 controlled-record digests, superseding the E0-S4 table | [`../evidence/gates/g1/e1-s1/e1-s1-provisional-contract-baseline-v11.md`](../evidence/gates/g1/e1-s1/e1-s1-provisional-contract-baseline-v11.md), which supersedes [`…-v10.md`](../evidence/gates/g1/e1-s1/e1-s1-provisional-contract-baseline-v10.md) and through it v9 down to v1 for the table and verification run. v11 is the accepted current record; it approves the audits 15–16 contract corrections and records the audit 18–19 governance, deadline, and bounded-harness remediation. Three provenance-reconciliation records sit beside them and account for named digest movements the superseded drafts pin |
